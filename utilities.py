...
def calc_azimuth(coord1_deg, coord2_deg): # theta is 0 on the pos x-axis and pi/2 on the pos y-axis in the defined coordinate system
...
def calc_th(coord1_deg, coord2_deg):
